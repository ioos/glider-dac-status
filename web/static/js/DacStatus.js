(function() {
  var DacStatus = function(templates) {
      ...
      this.status_template = templates['StatusTablet.html'];
      Mustache.parse(this.status_template);

      this.deployment_template = templates['DeploymentsTemplate.html'];
  ...
  DacStatus.prototype.onClickInstitution = function(event) {
      ...
      this._createStatusTable(datasets);
  ...
  DacStatus.prototype.onClickIncompleteDatasets = function(event) {
      ...
      if (numMissing > 0) {
        ...
        this._createStatusTable(latest);
  ...
  DacStatus.prototype.onClickAllDatasets = function(event) {
      ...
      this._createStatusTable(this.status_datasets);
  };
  ...
  DacStatus.prototype._createStatusTable = function(json) {
